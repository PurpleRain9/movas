		...
		<div class="col-md-8">
			...
			<div id="wrapper">
				<div class="header my-4" style="text-align: center;">
					<h1><span class="eng" id="eng">Add New Director</span><span class="mm" id="mm">ဒါရိုက်တာအသစ်ထည့်ရန်</span></h1>
				</div>
				<br>
				...
				<div class="content">
					<form action="{{route('director.store')}}" method="post" enctype="multipart/form-data">
						...
						<div class="row mt-3 control">
							...
							<div class="col-md-9">
								<input type="file" name="formc_file_name" class="form-control" required  accept=".pdf">
							</div>
						</div>
						...
						<div class="row mt-3 control">
							...
							<div class="col-md-9">
								<input type="file" class="form-control" name="extract_filename" required accept=".pdf">
							</div>
						</div>
						<div class="row mt-3 control">
							<div class="col-md-3 label">
