	...
	<div class="container mt-3 mb-4">
		...
		<div id="Applicant1" class="tabcontent">
			...
			<div class="row mt-3">
				...
				<div class="row mt-2 appDivFirst1">
					<div class="col-6 passport1">
						<fieldset class="form-group">
							<label ><span class="mm">Passport </span><span class="eng">Passport </span></label>
							<input type="file"   class="form-control " name="passport1" accept="application/pdf" >
						</fieldset>
					</div>
					<div class="col-6 letter1">
						<fieldset class="form-group">
							<label class="AppLetter1"><span class="mm">MIC Approved Letter </span><span class="eng">MIC Approved Letter </span></label>
							<label class="techAppLetter1"><span class="mm">MIC Approved Letter of Techanician </span><span class="eng">MIC Approved Letter  of Techanician  </span></label>
							<input type="file"   class="form-control " name="micLetter1" accept="application/pdf" >
						</fieldset>
					</div>
					<div class="col-6 extract1">
						<fieldset class="form-group">
							<label ><span class="mm">Extract Form</span><span class="eng">Extract Form</span></label>
							<input type="file"   class="form-control " name="extract1" accept="application/pdf" >
						</fieldset>
					</div>
				</div>
				<div class="row mt-2 appDivLast1">
					<div class="col-6 labourCard1">
						<fieldset class="form-group">
							<label ><span class="mm">Labour Card </span><span class="eng">Labour Card </span></label>
							<input type="file"   class="form-control " name="labourCard1" accept="application/pdf" >
						</fieldset>
					</div>
					<div class="col-6 techPassport1">
						<fieldset class="form-group">
							<label ><span class="mm">Technician Passport </span><span class="eng">Technician Passport </span></label>
							<input type="file"   class="form-control " name="techPassport1" accept="application/pdf" >
						</fieldset>
					</div>
					<div class="col-6 evidence1">
						<fieldset class="form-group">
							<label ><span class="mm">Evidence </span><span class="eng">Evidence </span></label>
							<input type="file"   class="form-control " name="evidence1" accept="application/pdf" >
						</fieldset>
					</div>
				</div>
				<script>
				...
				{{-- <table class="table table-bordered mt-3" id="ApplicantTable1">
					<tr>
						<th>File</th>
		...
		<div id="Applicant2" class="tabcontent">
			...
			<div class="row mt-3">
				...
				<div class="row mt-2 appDivFirst2">
					<div class="col-6 passport2">
						<fieldset class="form-group">
							<label ><span class="mm">Passport </span><span class="eng">Passport </span></label>
							<input type="file"   class="form-control " name="passport2" accept="application/pdf" >
						</fieldset>
					</div>
					<div class="col-6 letter2">
						<fieldset class="form-group">
							<label class="AppLetter2"><span class="mm">MIC Approved Letter </span><span class="eng">MIC Approved Letter </span></label>
							<label class="techAppLetter2"><span class="mm">MIC Approved Letter of Techanician </span><span class="eng">MIC Approved Letter  of Techanician  </span></label>
							<input type="file"   class="form-control " name="micLetter2" accept="application/pdf" >
						</fieldset>
					</div>
					<div class="col-6 extract2">
						<fieldset class="form-group">
							<label ><span class="mm">Extract Form</span><span class="eng">Extract Form</span></label>
							<input type="file"   class="form-control " name="extract2" accept="application/pdf" >
						</fieldset>
					</div>
				</div>
				<div class="row mt-2 appDivLast2">
					<div class="col-6 labourCard2">
						<fieldset class="form-group">
							<label ><span class="mm">Labour Card </span><span class="eng">Labour Card </span></label>
							<input type="file"   class="form-control " name="labourCard2" accept="application/pdf" >
						</fieldset>
					</div>
					<div class="col-6 techPassport2">
						<fieldset class="form-group">
							<label ><span class="mm">Technician Passport </span><span class="eng">Technician Passport </span></label>
							<input type="file"   class="form-control " name="techPassport2" accept="application/pdf" >
						</fieldset>
					</div>
					<div class="col-6 evidence2">
						<fieldset class="form-group">
							<label ><span class="mm">Evidence </span><span class="eng">Evidence </span></label>
							<input type="file"   class="form-control " name="evidence2" accept="application/pdf" >
						</fieldset>
					</div>
				</div>
				{{-- <div class="col">
				...
				{{-- <table class="table table-bordered mt-3" id="ApplicantTable2">
					<tr>
						<th>File</th>
		...
		<div id="Applicant3" class="tabcontent">
			...
			<div class="row mt-3">
				...
				<div class="row mt-2 appDivFirst3">
					<div class="col-6 passport3">
						<fieldset class="form-group">
							<label ><span class="mm">Passport </span><span class="eng">Passport </span></label>
							<input type="file"   class="form-control " name="passport3" accept="application/pdf" >
						</fieldset>
					</div>
					<div class="col-6 letter3">
						<fieldset class="form-group">
							<label class="AppLetter3"><span class="mm">MIC Approved Letter </span><span class="eng">MIC Approved Letter </span></label>
							<label class="techAppLetter3"><span class="mm">MIC Approved Letter of Techanician </span><span class="eng">MIC Approved Letter  of Techanician  </span></label>
							<input type="file"   class="form-control " name="micLetter3" accept="application/pdf" >
						</fieldset>
					</div>
					<div class="col-6 extract3">
						<fieldset class="form-group">
							<label ><span class="mm">Extract Form</span><span class="eng">Extract Form</span></label>
							<input type="file"   class="form-control " name="extract3" accept="application/pdf" >
						</fieldset>
					</div>
				</div>
				<div class="row mt-2 appDivLast3">
					<div class="col-6 labourCard3">
						<fieldset class="form-group">
							<label ><span class="mm">Labour Card </span><span class="eng">Labour Card </span></label>
							<input type="file"   class="form-control " name="labourCard3" accept="application/pdf" >
						</fieldset>
					</div>
					<div class="col-6 techPassport3">
						<fieldset class="form-group">
							<label ><span class="mm">Technician Passport </span><span class="eng">Technician Passport </span></label>
							<input type="file"   class="form-control " name="techPassport3" accept="application/pdf" >
						</fieldset>
					</div>
					<div class="col-6 evidence3">
						<fieldset class="form-group">
							<label ><span class="mm">Evidence </span><span class="eng">Evidence </span></label>
							<input type="file"   class="form-control " name="evidence3" accept="application/pdf" >
						</fieldset>
					</div>
				</div>
				{{-- <div class="col">
				...
				{{-- <table class="table table-bordered mt-3" id="ApplicantTable3">
					<tr>
						<th>File</th>
		...
		<div id="Applicant4" class="tabcontent">
			...
			<div class="row mt-3">
				...
				<div class="row mt-2 appDivFirst4">
					<div class="col-6 passport4">
						<fieldset class="form-group">
							<label ><span class="mm">Passport </span><span class="eng">Passport </span></label>
							<input type="file"   class="form-control " name="passport4" accept="application/pdf" >
						</fieldset>
					</div>
					<div class="col-6 letter4">
						<fieldset class="form-group">
							<label class="AppLetter4"><span class="mm">MIC Approved Letter </span><span class="eng">MIC Approved Letter </span></label>
							<label class="techAppLetter4"><span class="mm">MIC Approved Letter of Techanician </span><span class="eng">MIC Approved Letter  of Techanician  </span></label>
							<input type="file"   class="form-control " name="micLetter4" accept="application/pdf" >
						</fieldset>
					</div>
					<div class="col-6 extract4">
						<fieldset class="form-group">
							<label ><span class="mm">Extract Form</span><span class="eng">Extract Form</span></label>
							<input type="file"   class="form-control " name="extract4" accept="application/pdf" >
						</fieldset>
					</div>
				</div>
				<div class="row mt-2 appDivLast4">
					<div class="col-6 labourCard4">
						<fieldset class="form-group">
							<label ><span class="mm">Labour Card </span><span class="eng">Labour Card </span></label>
							<input type="file"   class="form-control " name="labourCard4" accept="application/pdf" >
						</fieldset>
					</div>
					<div class="col-6 techPassport4">
						<fieldset class="form-group">
							<label ><span class="mm">Technician Passport </span><span class="eng">Technician Passport </span></label>
							<input type="file"   class="form-control " name="techPassport4" accept="application/pdf" >
						</fieldset>
					</div>
					<div class="col-6 evidence4">
						<fieldset class="form-group">
							<label ><span class="mm">Evidence </span><span class="eng">Evidence </span></label>
							<input type="file"   class="form-control " name="evidence4" accept="application/pdf" >
						</fieldset>
					</div>
				</div>
				{{-- <div class="col">
...
{{-- 
				<table class="table table-bordered mt-3" id="ApplicantTable4">
					<tr>
						<th>File</th>
		...
		<div id="Applicant5" class="tabcontent">
			...
			<div class="row mt-3">
				...
				<div class="row mt-2 appDivFirst5">
					<div class="col-6 passport5">
						<fieldset class="form-group">
							<label ><span class="mm">Passport </span><span class="eng">Passport </span></label>
							<input type="file"   class="form-control " name="passport5" accept="application/pdf" >
						</fieldset>
					</div>
					<div class="col-6 letter5">
						<fieldset class="form-group">
							<label class="AppLetter5"><span class="mm">MIC Approved Letter </span><span class="eng">MIC Approved Letter </span></label>
							<label class="techAppLetter5"><span class="mm">MIC Approved Letter of Techanician </span><span class="eng">MIC Approved Letter  of Techanician  </span></label>
							<input type="file"   class="form-control " name="micLetter5" accept="application/pdf" >
						</fieldset>
					</div>
					<div class="col-6 extract5">
						<fieldset class="form-group">
							<label ><span class="mm">Extract Form</span><span class="eng">Extract Form</span></label>
							<input type="file"   class="form-control " name="extract5" accept="application/pdf" >
						</fieldset>
					</div>
				</div>
				<div class="row mt-2 appDivLast5">
					<div class="col-6 labourCard5">
						<fieldset class="form-group">
							<label ><span class="mm">Labour Card </span><span class="eng">Labour Card </span></label>
							<input type="file"   class="form-control " name="labourCard5" accept="application/pdf" >
						</fieldset>
					</div>
					<div class="col-6 techPassport5">
						<fieldset class="form-group">
							<label ><span class="mm">Technician Passport </span><span class="eng">Technician Passport </span></label>
							<input type="file"   class="form-control " name="techPassport5" accept="application/pdf" >
						</fieldset>
					</div>
					<div class="col-6 evidence5">
						<fieldset class="form-group">
							<label ><span class="mm">Evidence </span><span class="eng">Evidence </span></label>
							<input type="file"   class="form-control " name="evidence5" accept="application/pdf" >
						</fieldset>
					</div>
				</div>
				{{-- <div class="col">
				...
				{{-- <table class="table table-bordered mt-3" id="ApplicantTable5">
					<tr>
						<th>File</th>
		...
		<div id="Applicant6" class="tabcontent">
			...
			<div class="row mt-3">
				...
				<div class="row mt-2 appDivFirst6">
					<div class="col-6 passport6">
						<fieldset class="form-group">
							<label ><span class="mm">Passport </span><span class="eng">Passport </span></label>
							<input type="file"   class="form-control " name="passport6" accept="application/pdf" >
						</fieldset>
					</div>
					<div class="col-6 letter6">
						<fieldset class="form-group">
							<label class="AppLetter6"><span class="mm">MIC Approved Letter </span><span class="eng">MIC Approved Letter </span></label>
							<label class="techAppLetter6"><span class="mm">MIC Approved Letter of Techanician </span><span class="eng">MIC Approved Letter  of Techanician  </span></label>
							<input type="file"   class="form-control " name="micLetter6" accept="application/pdf" >
						</fieldset>
					</div>
					<div class="col-6 extract6">
						<fieldset class="form-group">
							<label ><span class="mm">Extract Form</span><span class="eng">Extract Form</span></label>
							<input type="file"   class="form-control " name="extract6" accept="application/pdf" >
						</fieldset>
					</div>
				</div>
				<div class="row mt-2 appDivLast6">
					<div class="col-6 labourCard6">
						<fieldset class="form-group">
							<label ><span class="mm">Labour Card </span><span class="eng">Labour Card </span></label>
							<input type="file"   class="form-control " name="labourCard6" accept="application/pdf" >
						</fieldset>
					</div>
					<div class="col-6 techPassport6">
						<fieldset class="form-group">
							<label ><span class="mm">Technician Passport </span><span class="eng">Technician Passport </span></label>
							<input type="file"   class="form-control " name="techPassport6" accept="application/pdf" >
						</fieldset>
					</div>
					<div class="col-6 evidence6">
						<fieldset class="form-group">
							<label ><span class="mm">Evidence </span><span class="eng">Evidence </span></label>
							<input type="file"   class="form-control " name="evidence6" accept="application/pdf" >
						</fieldset>
					</div>
				</div>
				{{-- <div class="col">
				...
				{{-- <table class="table table-bordered mt-3" id="ApplicantTable6">
					<tr>
						<th>File</th>
		...
		<div id="Applicant7" class="tabcontent">
			...
			<div class="row mt-3">
				...
				<div class="row mt-2 appDivFirst7">
					<div class="col-6 passport7">
						<fieldset class="form-group">
							<label ><span class="mm">Passport </span><span class="eng">Passport </span></label>
							<input type="file"   class="form-control " name="passport7" accept="application/pdf" >
						</fieldset>
					</div>
					<div class="col-6 letter7">
						<fieldset class="form-group">
							<label class="AppLetter7"><span class="mm">MIC Approved Letter </span><span class="eng">MIC Approved Letter </span></label>
							<label class="techAppLetter7"><span class="mm">MIC Approved Letter of Techanician </span><span class="eng">MIC Approved Letter  of Techanician  </span></label>
							<input type="file"   class="form-control " name="micLetter7" accept="application/pdf" >
						</fieldset>
					</div>
					<div class="col-6 extract7">
						<fieldset class="form-group">
							<label ><span class="mm">Extract Form</span><span class="eng">Extract Form</span></label>
							<input type="file"   class="form-control " name="extract7" accept="application/pdf" >
						</fieldset>
					</div>
				</div>
				<div class="row mt-2 appDivLast7">
					<div class="col-6 labourCard7">
						<fieldset class="form-group">
							<label ><span class="mm">Labour Card </span><span class="eng">Labour Card </span></label>
							<input type="file"   class="form-control " name="labourCard7" accept="application/pdf" >
						</fieldset>
					</div>
					<div class="col-6 techPassport7">
						<fieldset class="form-group">
							<label ><span class="mm">Technician Passport </span><span class="eng">Technician Passport </span></label>
							<input type="file"   class="form-control " name="techPassport7" accept="application/pdf" >
						</fieldset>
					</div>
					<div class="col-6 evidence7">
						<fieldset class="form-group">
							<label ><span class="mm">Evidence </span><span class="eng">Evidence </span></label>
							<input type="file"   class="form-control " name="evidence7" accept="application/pdf" >
						</fieldset>
					</div>
				</div>
				<script>
				...
				{{-- <table class="table table-bordered mt-3" id="ApplicantTable7">
					<tr>
						<th>File</th>
		  ...
		  <div class="modal-dialog" role="document">
		    <div class="modal-content">
		      ...
		      <div class="modal-body">
				...
				<p id="msg1" class="text-danger d-none"></p>

				<p class="text-danger d-none" id="labourMsg"></p>
		      ...
		      <div class="modal-footer">
				...
				{{-- <button type="submit" class="btn mybutton" id="btnsave" style="background-color: #4CAF50;" >Confirm & Apply</button> --}}
...
<script src="{{ asset('js/applicantAttach.js') }}"></script>
<script type="text/javascript">
	var checkTwoMonths = "{{route('checkTwoMonths')}}";
	var checkLabourType = "{{route('checkLabourType')}}";
	...
	$('.mybutton').on('click',function(e){
		...
		// 	var d = new Date(user_info[key]['StayExpireDate']);

		// 	var expireDate = new Date(d.setMonth(d.getMonth()+2)).toISOString().split('T')[0];

		// 	const currentDate = new Date().toISOString().split('T')[0];
		// 	console.log('stay expire date'+user_info[key]['StayExpireDate']);
		...
		// 		console.log('must');
		// 		if($('#comName').val() == user_info[key]['CompanyName'] && $('#PersonName1').val() == user_info[key]['PersonName'] && $('.PassportNo1').val() == user_info[key]['PassportNo'] && (($('#visa_type_id1').val() != '' && user_info[key]['visa_type_id'] != null) || ($('#stay_type_id1').val() != '' && user_info[key]['stay_type_id'] != null) || ($('#labour_card_type_id1').val() != '' && user_info[key]['labour_card_type_id'] != null))){
		// 		 	saveDisable = "1";
		// 		 	applicant = "1";
		// 		 	console.log('not apply');
		// 		}
		// 		if($('#comName').val() == user_info[key]['CompanyName'] && $('#PersonName2').val() == user_info[key]['PersonName'] && $('.PassportNo2').val() == user_info[key]['PassportNo'] && (($('#visa_type_id2').val() != '' && user_info[key]['visa_type_id'] != null) || ($('#stay_type_id2').val() != '' && user_info[key]['stay_type_id'] != null) || ($('#labour_card_type_id2').val() != '' && user_info[key]['labour_card_type_id'] != null))){
		// 		 	saveDisable = "1";
		// 		 	applicant = "2";
		// 		}
		// 		if($('#comName').val() == user_info[key]['CompanyName'] && $('#PersonName3').val() == user_info[key]['PersonName'] && $('.PassportNo3').val() == user_info[key]['PassportNo'] && (($('#visa_type_id3').val() != '' && user_info[key]['visa_type_id'] != null) || ($('#stay_type_id3').val() != '' && user_info[key]['stay_type_id'] != null) || ($('#labour_card_type_id3').val() != '' && user_info[key]['labour_card_type_id'] != null))){
		// 		 	saveDisable = "1";
		// 		 	applicant = "3";
		// 		}
		// 		if($('#comName').val() == user_info[key]['CompanyName'] && $('#PersonName4').val() == user_info[key]['PersonName'] && $('.PassportNo4').val() == user_info[key]['PassportNo'] && (($('#visa_type_id4').val() != '' && user_info[key]['visa_type_id'] != null) || ($('#stay_type_id4').val() != '' && user_info[key]['stay_type_id'] != null) || ($('#labour_card_type_id4').val() != '' && user_info[key]['labour_card_type_id'] != null))){
		// 		 	saveDisable = "1";
		// 		 	applicant = "4";
		// 		}
		// 		if($('#comName').val() == user_info[key]['CompanyName'] && $('#PersonName5').val() == user_info[key]['PersonName'] && $('.PassportNo5').val() == user_info[key]['PassportNo'] && (($('#visa_type_id5').val() != '' && user_info[key]['visa_type_id'] != null) || ($('#stay_type_id5').val() != '' && user_info[key]['stay_type_id'] != null) || ($('#labour_card_type_id5').val() != '' && user_info[key]['labour_card_type_id'] != null))){
		// 		 	saveDisable = "1";
		// 		 	applicant = "5";
		// 		}
		// 		if($('#comName').val() == user_info[key]['CompanyName'] && $('#PersonName6').val() == user_info[key]['PersonName'] && $('.PassportNo6').val() == user_info[key]['PassportNo'] && (($('#visa_type_id6').val() != '' && user_info[key]['visa_type_id'] != null) || ($('#stay_type_id6').val() != '' && user_info[key]['stay_type_id'] != null) || ($('#labour_card_type_id6').val() != '' && user_info[key]['labour_card_type_id'] != null))){
		// 		 	saveDisable = "1";
		// 		 	applicant = "6";
		// 		}
		// 		if($('#comName').val() == user_info[key]['CompanyName'] && $('#PersonName7').val() == user_info[key]['PersonName'] && $('.PassportNo7').val() == user_info[key]['PassportNo'] && (($('#visa_type_id7').val() != '' && user_info[key]['visa_type_id'] != null) || ($('#stay_type_id7').val() != '' && user_info[key]['stay_type_id'] != null) || ($('#labour_card_type_id7').val() != '' && user_info[key]['labour_card_type_id'] != null))){
		// 		 	saveDisable = "1";
		// 		 	applicant = "7";
		// 		}
		// 	}
		...
		var data = {
			'name[1]': $('#PersonName1').val(),
			'name[2]': $('#PersonName2').val(),
			'name[3]': $('#PersonName3').val(),
			'name[4]': $('#PersonName4').val(),
			'name[5]': $('#PersonName5').val(),
			'name[6]': $('#PersonName6').val(),
			'name[7]': $('#PersonName7').val(),
			'passport[1]': $('.PassportNo1').val(),
			'passport[2]': $('.PassportNo2').val(),
			'passport[3]': $('.PassportNo3').val(),
			'passport[4]': $('.PassportNo4').val(),
			'passport[5]': $('.PassportNo5').val(),
			'passport[6]': $('.PassportNo6').val(),
			'passport[7]': $('.PassportNo7').val(),
			'stay[1]': $('#stay_type_id1').val(),
			'stay[2]': $('#stay_type_id2').val(),
			'stay[3]': $('#stay_type_id3').val(),
			'stay[4]': $('#stay_type_id4').val(),
			'stay[5]': $('#stay_type_id5').val(),
			'stay[6]': $('#stay_type_id6').val(),
			'stay[7]': $('#stay_type_id7').val(),
		};
		console.log(data);
		$.ajax({
            type: 'GET',
            ...
            success:function(res){                
                if (res.success){
                	...
                	$('#msg1').text(res.message+' သည် နေထိုင်ခွင့်သက်တမ်းတိုးလျှောက်ထားခြင်းအား ခွင့်ပြုပြီး ၂ လ ပြည့်မှသာ ပြန်လည်လျှောက်ထားခွင့် ရနိုင်ပါမည်။');
		...
		var data1 = {
			...
			'passport[6]': $('.PassportNo6').val(),
			'passport[7]': $('.PassportNo7').val(),
			'labour[1]': $('#labour_card_type_id1').val(),
			'labour[2]': $('#labour_card_type_id2').val(),
			'labour[3]': $('#labour_card_type_id3').val(),
			'labour[4]': $('#labour_card_type_id4').val(),
			'labour[5]': $('#labour_card_type_id5').val(),
			'labour[6]': $('#labour_card_type_id6').val(),
			'labour[7]': $('#labour_card_type_id7').val(),
		}
        $.ajax({
            type: 'GET',
            url: checkLabourType,
            ...
            success:function(res){                
                if (res.success){
                	$('#labourMsg').addClass('d-none');
                }else{
                	console.log(res.message);
                	$('#labourMsg').removeClass('d-none');
                	$('#labourMsg').text(res.message+' သည် အလုပ်သမားကဒ် လျှောက်ထားပြီးသားဖြစ်သောကြောင့် သက်တမ်းတိုးသာ လျှောက်ခွင့်ရှိပါမည်။');
                	$('#btnsave').removeAttr('style');
	        		$('#btnsave').addClass('btn-secondary');
	        		$('#btnsave').addClass('disabled');
                }
