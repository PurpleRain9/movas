		...
		<div class="col-md-8">
			...
			<div id="wrapper">
				<div class="header my-4" style="text-align: center;">
					<h1><span class="eng" id="eng">Edit Dependent</span><span class="mm" id="mm">မှီခို ပြင်ဆင်ရန်</span></h1>
				</div>
				<br>
				<fornt face="verdana" color="red" size="1" style="display:none"><b>Message Show</b></fornt>

				<div class="content">
					<form action="{{route('DP.update',$playlist->id)}}" method="post" enctype="multipart/form-data">
						...
						<div class="row control">
							...
							<div class="col-md-9">
								...
								<div class="img-preview" id="imgPreview">
									<img src="{{ $playlist->image }}" alt="Image Preview" class="img-preview__image" />
                        ...
                        <div class="row mt-3 control">
							...
							<div class="col-md-9">
								<input type="text" class="form-control" name="passport_no" value="{{ $playlist->passport_no }}" required>
							</div>
						</div>
                        <div class="row mt-3 control">
							<div class="col-md-3 lable">
							...
							<div class="col-md-9">
								<input type="text" name="phone_no" class="form-control" value="{{ $playlist->phone_no }}" required>
							</div>
						</div>
                        <div class="row mt-3 control">
							<div class="col-md-3 lable">
							...
							<div class="col-md-9">
								<input type="text" name="rank" class="form-control" value="{{ $playlist->rank }}" required>
							</div>
						</div>
						<div class="row mt-3 control">
							<div class="col-md-3 lable">
							...
							<div class="col-md-9">
								<input type="text" name="qualification" class="form-control" value="{{ $playlist->qualification }}"  required>
							</div>
						</div>
                        <div class="row mt-3 control">
							<div class="col-md-3 lable">
							...
							<div class="col-md-9">
								<input type="date" class="form-control" name="date_of_birth" value="{{ $playlist->date_of_birth  }}" required>
							</div>
						</div>
                        <div class="row mt-3 control">
							<div class="col-md-3 lable">
							...
							<div class="col-md-9">
                                <textarea name="relation" id="" class="form-control"  rows="5">{{ $playlist->relation }}</textarea>
							</div>
						</div>
						...
						<div class="row mt-3 control">
							...
							<div class="col-md-9">
								<textarea name="permanent_address" id="home_address" class="form-control" cols="10" rows="5" required>{{ $playlist->permanent_address }}</textarea>
							</div>
						</div>
                        <div class="row mt-3 control">
							<div class="col-md-3 lable">
						...
						<div class="row mt-3 control">
							...
							<div class="col-md-9">
								<textarea name="formc_address" id="address" cols="30" rows="5" class="form-control" required>{{ $playlist->formc_address }}</textarea>
							</div>
						</div>
						...
						<div class="mt-3 control row">
							...
							<div class="col-md-9">
                                ...
                                <input type="radio" style="margin-left: 2rem;"  id="female" name="gender" value="female" {{ $playlist->gender == 'female' ? 'checked' : '' }}>
						...
						<div class="row mt-3">
							<div class="col-md-8" id="btt">
								...
								<a href="{{route('DP.show')}}" class="btn btn-danger my-3">Back</a>
							</div>
						</div>
					</form>
				</div>
