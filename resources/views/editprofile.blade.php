				...
				<div class="row mt-3">
					...
					<div class="col">
						<fieldset class="form-group">
    					    ...
    					    <input type="file" onchange="validateFileSize(this);" class="form-control" name="AttachPermit" id="pxq11" value="/public/{{Auth::user()->profile->AttachPermit}}">
							@error('AttachPermit')
					...
					<div class="col">
						<fieldset class="form-group">
    						...
    						<input type="file" onchange="validateFileSize(this);" class="form-control" name="AttachProposal" id="pxq12" value="/public/{{Auth::user()->profile->AttachProposal}}">
				...
				<div class="row mt-3">
					<div class="col">
						<fieldset class="form-group">
    						...
    						<input type="file" onchange="validateFileSize(this);" class="form-control" name="AttachAppointed" id="pxq13" value="/public/{{Auth::user()->profile->AttachAppointed}}">
					...
					<div class="col">
						<fieldset class="form-group">
    						...
    						<input type="file" onchange="validateFileSize(this);" class="form-control" name="AttachIncreased" id="pxq14" value="/public/{{Auth::user()->profile->AttachIncreased}}">
							@error('AttachIncreased')
								<span class="text-danger"><small>* {{ $message }}</small></span>
							@enderror
