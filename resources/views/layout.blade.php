...
<body>
			...
			<div class="col-md-10">
				...
				<div style="float: right;" class="d-flex">
					...
					<div class="dropdown ms-4">
						<a class=" dropdown-toggle text-reset text-decoration-none"  id="dropdownMenu2" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
							<b>	{{Auth::user()->name}}</b>
						</a>
						<div class="dropdown-menu" aria-labelledby="dropdownMenu2">
							<a class="dropdown-item" href="{{route('changeEmail')}}">Change Email</a>
							<a class="dropdown-item" href="{{route('changePassword')}}">Change Password</a>
							<a class="dropdown-item" href="{{route('contactInfoHistory.index')}}">Change Contact Info</a>
							<a style="text-decoration: none;" href="{{ route('logout') }}" class="dropdown-item"
	...
	@if (Auth::user()->Status == 2 )
		<nav class="navbar navbar-expand-lg navbar-light my-nav" style="background-color: #00ab46;padding-top: 0px;padding-bottom: 0px;">
		...
		<div class="collapse navbar-collapse" id="navbarNavDropdown" style="margin-left: 30px;">
			<ul class="navbar-nav" style="font-weight: bold; text-transform: uppercase;">
				<li class="nav-item" style="margin-right: 30px;">
					<a class="nav-link" href="{{ route('home') }}" style="color: white; {{ request()->routeIs('home') ? 'background: #0a7736;' : '' }}"><span class="mm">မူလစာမျက်နှာ</span><span class="eng">Home</span></a>
				</li>
				<li class="nav-item" style="margin-right: 30px;">
					<a class="nav-link" href="{{ route('editprofile') }}" style="color: white; {{ request()->routeIs('editprofile') ? 'background: #0a7736;' : '' }}"><span class="mm">ကုမ္ပဏီအချက်အလက်</span><span class="eng">Profile</span></a>
				</li>
				
				<li class="nav-item" style="margin-right: 30px;">
                    <a class="nav-link" href="{{route('applyformNew')}}" style="color: white; {{ request()->routeIs('applyformNew') || request()->routeIs('newapplyform') ? 'background: #0a7736;' : '' }}"><span class="mm">လျှောက်လွှာတင်ရန်</span><span class="eng">Visa Application</span></a>
				</li>

				<li class="nav-item" style="margin-right: 30px;">
                    <a class="nav-link" href="{{ route('FT.show') }}" style="color: white; {{ request()->routeIs('FT.show') || request()->routeIs('FT.create') || request()->routeIs('FT.edit') ? 'background: #0a7736;' : '' }}"><span class="mm">နိုင်ငံခြားသားပညာရှင်</span><span class="eng">Foreign Technician / Skilled Labour</span></a>
				</li>
				<li class="nav-item" style="margin-right: 30px;">
                    <a class="nav-link" href="{{ route('director.show') }}" style="color: white; {{ request()->routeIs('director.show') || request()->routeIs('director.create') || request()->routeIS('director.edit') ? 'background: #0a7736;' : '' }}"><span class="mm">ဒါရိုက်တာ</span><span class="eng">Director</span></a>
				</li>
				<li class="nav-item" style="margin-right: 30px;">
                    <a class="nav-link" href="{{ route('DP.show') }}" style="color: white; {{ request()->routeIs('DP.show') || request()->routeIs('DP.create') || request()->routeIs('DP.edit') ? 'background: #0a7736;' : '' }}"><span class="mm">မှီခို</span><span class="eng">Dependant</span></a>
				</li>
				<li class="nav-item" style="margin-right:30px">
					<a class="nav-link" href="{{ route('undertaking.show') }}" style="color: white; {{ request()->routeIs('undertaking.show') ? 'background: #0a7736;' : '' }}"><span class="mm">ကတိခံဝန်ချက်</span><span class="eng">Undertaking Letter</span></a>
				</li>
