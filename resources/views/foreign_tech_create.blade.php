				...
				<div class="content">
					<form action="{{route('FT.store')}}" method="post" enctype="multipart/form-data">
						...
						<div class="row mt-3 control">
							...
							<div class="col-md-9">
								<textarea name="home_address" id="home_address" class="form-control" cols="10" rows="5" required></textarea>
							</div>
						</div>
						...
						<div class="row mt-3 control">
							...
							<div class="col-md-9">
								<input type="file" name="form_c_filename" class="form-control" required>
							</div>
						</div>
