		...
		<div class="col-md-8">
			...
			<div id="wrapper">
				<div class="header my-4" style="text-align: center;">
					<h1><span class="eng" id="eng">Update Technician Information</span><span class="mm" id="mm">နည်းပညာရှင်၏ အချက်အလက်ပြောင်းရန်</span></h1>
				</div>
				<br>
				<font face="verdana" color="red" size="1" style="display:none"><b>Message Show</b></font>

				<div class="content">
					<form  action="{{route('FT.update',$playlist->id)}}" method="post" enctype="multipart/form-data">
						...
						<div class="row mt-3 control">
							...
							<div class="col-md-9">
								<textarea name="address" id="address" class="form-control" cols="10" rows="5" placeholder="Form C Address">{{$playlist->address}}</textarea>
							</div>
						</div>
						<div class="row mt-3 control">
							<div class="col-md-3 label">
							...
							<div class="col-md-9">
								<textarea name="home_address" id="home_address" class="form-control" cols="10" rows="5" placeholder="Permanent Address in Home Country">{{$playlist->home_address}}</textarea>
							</div>
						</div>
						...
						<div class="row mt-3 control">
							...
							<div class="col-md-9">
								<input type="date" class="form-control" name="DateOfBirth" value="{{ $playlist->DateOfBirth }}">
							</div>
						</div>
						...
						<div class="row control mt-3" id="mt">
							...
							<div class="col-md-9">
								<input type="file" class="form-control" name="form_c_filename">
							</div>
						</div>

						<div class="row mt-3 control">
							<div class="col-md-3 label">
								<span class="mm">အလုပ်သမား ကဒ်</span><span class="eng">Labour Card</span>
							</div>
							<div class="col-md-9">
								<input type="file" class="form-control" name="larbourCard">
							</div>
						</div>

						<div class="row mt-3">
							<div class="col-md-3">
								<span class="mm">MIC မှခွင့် ပြုသည့်စာရှိ့ ပါသလား?</span><span class="eng">Do you have MIC Approved Letter?</span>
							</div>
							<div class="col-md-9">
								<input type="radio" id="yes" name="noll" value="yes">
								<label for="yes">Yes</label>
								<input type="radio" id="no" name="noll" value="no" checked>
								<label for="no">No</label>
							</div>
						</div>

						<div class="row mt-3 control" id=micApproved>
							<div class="col-md-3 ">
								<span class="mm">MIC မှခွင့်ပြုသည့်စာ</span><span class="eng">MIC Approved Letter</span>
							</div>
							<div class="col-md-9">
								<input type="file" class="form-control" name="micApprovedFile">
							</div>
						</div>
