...
<div class="row">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card justify-content-center" style="border: 1px solid lightgray;overflow: hidden;">
                    <div class="card-header" style="background-color: #BBDEFB;">
                        Applied Person By Stay, Visa & Labour Card
                    </div>
                    <div class="card-body pt-4">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card justify-content-center" style="border: 1px solid lightgray;overflow: hidden;">
                    <div class="card-header" style="background-color: #BBDEFB;">
                        Approved Person By Stay, Visa & Labour Card
                    </div>
                    <div class="card-body pt-4">
...
<div class="row mb-3">
            <div class="col-md-12">
                <div class="card justify-content-center" style="border: 1px solid lightgray;overflow: hidden;">
                    ...
                    <div class="card-body pt-4">
                        <div id="approved" style="height:400px;margin-left: -50px;margin-right: -100px;">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <script type="text/javascript">
            ...
            function drawChart() {
                ...
                var options = {
                    title: 'Applied Person By Stay, Visa & Labour Card',
                    colors: ['#889fd7', '#f8a784', '#c0c0c0'],
                    curveType: 'function',
                    legend: {
                        position: 'bottom'
        ...
        <script type="text/javascript">
            ...
            function drawChart() {
                ...
                var options = {
                    title: 'Approved Person By Stay, Visa & Labour Card',
                    colors: ['#889fd7', '#f8a784', '#c0c0c0'],
                    curveType: 'function',
                    legend: {
                        position: 'bottom'
        ...
        <script type="text/javascript">
            ...
            function drawChart() {
                ...
                var options = {
                    title: 'Applied Person By Gender',
                    colors: ['#889fd7', '#f8a784', '#c0c0c0'],
                    curveType: 'function',
                    legend: {
                        position: 'bottom'
        ...
        <script type="text/javascript">
            ...
            function drawChart() {
                ...
                var options = {
                    title: 'Approved Person By Gender',
                    colors: ['#889fd7', '#f8a784', '#c0c0c0'],
                    curveType: 'function',
                    legend: {
                        position: 'bottom'
        ...
        <script type="text/javascript">
            ...
            function drawChart() {
                ...
                var options = {
                    title: 'Applied Person By Applicant',
                    // colors: ['#889fd7', '#f8a784', '#c0c0c0'],
                    curveType: 'function',
                    legend: {
                        position: 'bottom'
        ...
        <script type="text/javascript">
            ...
            function drawChart() {
                ...
                var options = {
                    title: 'Approved Person By Applicant',
                    // colors: ['#889fd7', '#f8a784', '#c0c0c0'],
                    curveType: 'function',
                    legend: {
                        position: 'bottom'
        ...
        <!-- End Approved Person By Applicant -->
          ...
          <script type="text/javascript">
            ...
            function drawChart() {
                var data = google.visualization.arrayToDataTable(approved);
                var options = {
                ...
                var chartType = document.getElementById('chartType').value;
                if (chartType == 'line') {
                    var chart = new google.visualization.LineChart(document.getElementById('approved'));
                } else if (chartType == 'bar') {
                    var chart = new google.visualization.BarChart(document.getElementById('approved'));
                } else if (chartType == 'pie') {
                    var chart = new google.visualization.PieChart(document.getElementById('approved'));
                } else {
                    var chart = new google.visualization.ColumnChart(document.getElementById('approved'));
                }
                // var chart = new google.visualization.ColumnChart(document.getElementById('appliedPersonByType'));
                chart.draw(data, options);
            }
        </script>
        <!-- End Approved Summary -->
