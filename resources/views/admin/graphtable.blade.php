...
@php
    ...
    $r_dmy = request()->DMY === null ? '' : request()->DMY;
    ...
    <form action="#" method="get">
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                ...
                <select name="DMY" id="DMY" class="form-control">
                    <option value="">Select</option>
                    <option value="D"  {{ $r_dmy == 'D' ? 'selected' : '' }}>Daily</option>
                    <option value="M" {{ $r_dmy == 'M' ? 'selected' : '' }}>Monthly</option>
                    <option value="Y" {{ $r_dmy == 'Y' ? 'selected' : '' }}>Yearly</option>
                </select>
            </div>
            <div class="col-md-3 col-sm-12" style="margin-top:2rem; ">
                    ...
                    <div class="scrollit" id="rejectedCase" style="height:450px;">
                        <table class="table table-sm">
                            ...
                            <tbody>
                                ...
                                @foreach( $Approved as $AVD)
                                    <tr class="tr21">
                                        <td>{{ $i++ }}</td>
                                        <td>{{ $AVD->d }}</td>
                                        <td class="loop21">{{ $AVD->DICA }}</td>
                                        <td class="loop211">{{ $AVD->Immigration }}</td>
                                        <td class="loop212">{{ $AVD->Labour }}</td>
                                    </tr>
                                @endforeach
