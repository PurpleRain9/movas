    ...
    <div class="container-scroller">
      ...
      <nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        ...
        <div class="navbar-menu-wrapper d-flex align-items-stretch" style="background: #e4f7eb;border-bottom: 1px solid lightblue;">
          ...
          <a href="{{ route('downloadSql') }}" class="btn btn-sm btn-outline-success my-3" style=" font-size:15px;"><i class="fa fa-download"></i> Download Database</a> 
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar" style="background: #e4f7eb;border-right: 1px solid lightblue;">
          <ul class="nav">
            ...
            <li class="nav-item">
                ...
                <li class="nav-item">
                  <a class="nav-link" href="{{route('newCase')}}">
                    <span class="icon-bg"><i class="mdi mdi-cube menu-icon"></i></span>
              ...
              @if (Auth::user()->rank_id == 2)
                <li class="nav-item">
                  <a class="nav-link" href="{{route('applyCase')}}">
                    <span class="icon-bg"><i class="mdi mdi-cube menu-icon"></i></span>
                    <span class="menu-title">Apply Case</span>
                  </a>
                </li>
              @endif
              ...
              @if (Auth::user()->rank_id == 2 || Auth::user()->rank_id == 1)
                <li class="nav-item">
              ...
              <li class="nav-item">
                <a class="nav-link" href="{{ route('rejectedform') }}">
                  ...
                  <span class="menu-title">Resubmitted Form</span>
                </a>
              </li>
              <li class="nav-item">
              ...
              <li class="nav-item">
                <a class="nav-link" href="{{ route('profileList')}}">
                  <span class="icon-bg"><i class="mdi mdi-cube menu-icon"></i></span>
              ...
              <li class="nav-item">
                <a class="nav-link" href="{{ route('resignList')}}">
                  <span class="icon-bg"><i class="mdi mdi-cube menu-icon"></i></span>
                  <span class="menu-title">Resign</span>
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="{{ route('applicantList')}}">
                  <span class="icon-bg"><i class="mdi mdi-cube menu-icon"></i></span>
              ...
              <li class="nav-item">
                <a class="nav-link" href="{{ route('profile.index') }}">
                  <span class="icon-bg"><i class="mdi mdi-cube menu-icon"></i></span>
                  {{-- <span class="menu-title mm">User Email Verify</span> --}}
                  <span class="menu-title">Profile Management</span>
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="{{ route('emailSend')}}">
                  <span class="icon-bg"><i class="mdi mdi-cube menu-icon"></i></span>
