            ...
            <div class="col-md-8">
                ...
                <div id="wrapper">
                    <div class="header my-4" style="text-align: center;">
                        <h1><span class="eng" id="eng">Add New Technician</span><span class="mm"
                                id="mm">နည်းပညာရှင်အသစ်ထည့်ရန်</span></h1>
                    </div>
                    <br>
                        ...
                        <form action="{{ route('FT.store') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row control">
                                ...
                                <div class="col-md-10">
                                    ...
                                    <input type="file" name="Image" class="form-control" placeholder="image"
                                        onchange="previewFile(this)" required accept=".jpg,.png">
                                    <img id="previewing" alt="profile img"
                                        style="max-width: 100px; max-width: 100px; margin-top: 20px;">
                                </div>
                            </div>
