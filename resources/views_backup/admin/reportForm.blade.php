                    ...
                    @if (isset($reports))
                        @foreach ($reports as $r)
                            <tr>
                                ...
                                <td style="text-align: center;">{{ $r->StayExpireDate }}</td>
                                @if($r->StayId== 1)
                                <td style="text-align: center;">{{ \Carbon\Carbon::parse($r->StayExpireDate)->addMonths(3)->format('Y-m-d'); }}</td>
                                @elseif($r->StayId == 2)
                                <td style="text-align: center;">{{ \Carbon\Carbon::parse($r->StayExpireDate)->addMonths(6)->format('Y-m-d'); }}</td>
                                @else
                                <td style="text-align: center;">{{ \Carbon\Carbon::parse($r->StayExpireDate)->addMonths(12)->format('Y-m-d'); }}</td>
                                @endif
